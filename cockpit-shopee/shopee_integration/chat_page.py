...
<title>Chat do coach &middot; Cockpit Papai Resolve</title>
...
<style>
  :root {{
    ...
    --focus: #1d64b0; --bolha-usuario: #d9670c; --bolha-coach: #ffffff;
  ...
  @media (prefers-color-scheme: dark) {{
    :root:not([data-theme="light"]) {{
      ...
      --focus: #6badf0; --bolha-usuario: #ff9439; --bolha-coach: #171e22;
      --erro: #e0776a; --erro-soft: #3a201c;
    }}
  }}
...
{nav.MENU_CSS}
  ...
  .cabecalho-texto .eyebrow {{ font-family: "IBM Plex Mono", monospace; font-size: 0.72rem; letter-spacing: 0.12em;
    text-transform: uppercase; color: var(--accent-ink); margin: 0 0 4px; font-weight: 600; }}
  h1 {{ font-family: "Archivo", sans-serif; font-weight: 800; font-size: 1.4rem; margin: 0; }}
  ...
  .msg-coach .bolha {{ background: var(--bg); border: 1px solid var(--border); border-bottom-left-radius: 3px; }}
  ...
  .aviso-config {{ font-size: 0.8rem; color: var(--muted); margin-top: 10px; font-family: "IBM Plex Mono", monospace; }}
</style>
</head>
<body>
  <div class="wrap">
