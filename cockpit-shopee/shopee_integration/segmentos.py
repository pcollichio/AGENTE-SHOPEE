...
_SEGMENTOS = [
    ("beleza", [
        ...
        "retinal", "oleo facial", "kit facial", "zero pore",
        "sabonete liquido", "creme renovador", "renovador facial",
        "renovadores faciais",
    ]),
    ("casa_construcao", [
        ...
        "prendedor de roupa", "varal", "cobertor", "colcha",
        "manta cobertor", "mop", "balde", "espelho", "lixeira",
        "chaleira", "espremedor", "cozedor de ovos",
        "processador de alimentos", "moedor de carne",
        "picador de alimentos", "jogo de chave", "caixa de ferramentas",
        "marmita", "saco de lixo", "sacos de lixo", "amaciante", "maquina de costura",
        "porta frios", "batedor eletrico", "mixer eletrico",
    ]),
    ("moda", [
        "vestido", "camiseta", "camisa", "blusa", "muscle tee",
        "calca", "shorts", "saia", "jaqueta", "sutia", "lingerie",
        "baby doll", "biquini", "sandalia", "tenis", "bolsa feminina",
        "bolsa transversal", "carteira", "cinto", "oculos de sol",
        "moletom", "conjunto academia", "top fitness", "legging",
        "meia calca", "regata feminina",
    ]),
    ("eletronicos", [
    ...
    ("infantil", [
        ...
        "lenco umedecido", "toalha umedecida baby",
    ]),
    ("esporte_lazer", [
