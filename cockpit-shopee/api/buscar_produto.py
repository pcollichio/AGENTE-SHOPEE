...
from shopee_integration import client, config  # noqa: E402
...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        termo = (query.get("q") or [""])[0].strip()

        if not termo:
            self._responder(400, {"erro": "Informe um produto para buscar (parâmetro q)."})
            return
        ...
        self._responder(200, {"produtos": produtos})
