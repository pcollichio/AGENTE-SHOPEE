  ...
  <div class="wrap">
    ...
    <div class="guia-processo">
      <ol>
        ...
        <li>
          <b>4. Publicar</b>
          <span class="obs">Manual, por enquanto.</span> Sobe no Instagram/TikTok colando a legenda pronta (com o link de afiliado na bio). Publicar direto daqui exigiria autorizar o agente a postar na sua conta (aprovação da Meta/TikTok) — ainda não configurado.
        </li>
        <li>
      ...
      <p class="guia-aviso">O Claude não grava vídeo nem publica nas redes sozinho — essas partes (2, 3 e 4) são manuais. O que o Agente Shopee automatiza é o roteiro, a legenda, a curadoria dos produtos e o acompanhamento de cada um até a venda.</p>
    </div>
      ...
      raiz.querySelectorAll('.seletor-etapa').forEach(function (sel) {{
        sel.addEventListener('change', function () {{
          ...
          fetch('/api/atualizar_esteira', {{
            ...
            .catch(function () {{
              alert('Não consegui falar com o servidor — essa função só funciona depois de publicado na Vercel.');
            }})
